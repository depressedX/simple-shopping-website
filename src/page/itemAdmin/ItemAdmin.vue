<template>
  <div class="content-wrapper">
    <h1>管理商品</h1>
    <span>下载数据 : </span><a href="javascript:void (0)" @click="downloadData"
                           style="text-decoration: underline">点此下载文件</a><br/>
    ...
    <br/>
    <span>修改优惠金额 : </span><input v-model="preference"/>
    <s-button @click="updatePreference">提交</s-button>
    <br/>
    <span>增删物品 : </span>
...
<script>
    ...
    import {commit,dispatch} from "../../store/index";
    ...
    export default {
        ...
        methods: {
            ...
            updatePreference() {
                resources.updatePreference(this.preference).then(
                    ()=>{
                        commit('createNoticeModal','修改成功')
